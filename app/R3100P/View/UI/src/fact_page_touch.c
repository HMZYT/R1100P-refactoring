...
static void _touch( lv_event_t *e )
{
    ...
    {
        page->pnts[ page->cur_line ] = lv_malloc( sizeof( lv_point_t ) * 128 );
        ...
        lv_line_set_points( page->lines[ page->cur_line ], (lv_point_precise_t*)page->pnts[ page->cur_line ], 1 );
    ...
    {        
        ...
        if (ps)
        {
            ...
            cur_idx++;
            lv_line_set_points( page->lines[ page->cur_line ], (lv_point_precise_t*)ps, cur_idx );
        }
