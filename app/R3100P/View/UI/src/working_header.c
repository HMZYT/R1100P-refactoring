...
static rc_lcd_header_connection_t *rc_lcd_header_connection_create(lv_obj_t *parent)
{
    ...
    lv_obj_remove_flag(conn->r[0], LV_OBJ_FLAG_SCROLLABLE);
    ...
    lv_obj_remove_flag(conn->r[1], LV_OBJ_FLAG_SCROLLABLE);
    ...
    lv_obj_remove_flag(conn->r[2], LV_OBJ_FLAG_SCROLLABLE);
    ...
    lv_obj_remove_flag(conn->r[3], LV_OBJ_FLAG_SCROLLABLE);
    ...
    lv_obj_remove_flag(conn->r[4], LV_OBJ_FLAG_SCROLLABLE);
