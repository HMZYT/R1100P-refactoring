...
lv_obj_t* working_page_arms_init(lv_obj_t *page)
{
    ...
    // 需要修改 arm_d_b:90px arm_d_c:86px arm_d_d:78px arm_d_e:68px arm_d_f:56px arm_d_g:32px
...
//    lv_img_set_zoom(p->arm_p07, 160);
    ...
    //观察者模式
    lv_subject_add_observer_obj(&subject_arms_all, arms_observer_list_cb, page, p);
...
static void arms_observer_list_cb(lv_observer_t *observer, lv_subject_t *subject)
{
    ...
    int16_t Vx[7],Vy[7],V[7],lg[7] = {0, 56, 38, 36, 33, 29, 25};
