#include "../inc/dialog_wireless_off.h"
...
lv_obj_t *xlv_msgbox_wireless_off_create(void)
{
    ...
    //lv_obj_t *mbox = lv_msgbox_create(NULL, NULL, "无线通道已关闭，按面板任意按键唤醒无线通道。", NULL, false);
