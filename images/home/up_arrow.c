...
#ifndef LV_ATTRIBUTE_IMAGE_UP_ARROW
#define LV_ATTRIBUTE_IMAGE_UP_ARROW
#endif

const LV_ATTRIBUTE_MEM_ALIGN LV_ATTRIBUTE_LARGE_CONST LV_ATTRIBUTE_IMAGE_UP_ARROW uint8_t up_arrow_map[] = {
